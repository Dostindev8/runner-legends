...
(function (global) {
  ...
  const POWER_HIT = {
    ...
    ascended: { dmg: 200, stun: 0.25, slow: 0, radius: 240 },
    voltz_sphere: { dmg: 180, stun: 0.2, slow: 0, radius: 170 },
    double_laser: { dmg: 90, stun: 0.35, slow: 0, pierce: 2 },
    dance: { dmg: 70, stun: 1.2, slow: 0.4, pulse: 0.7, radius: 360 },
    invincible: { dmg: 40, stun: 0.25, slow: 0.2, pulse: 0.85, radius: 200 },
    shadow: { dmg: 55, stun: 0.45, slow: 0, radius: 160 },
    bullet_time: { dmg: 0, stun: 0, slow: 0.35 },
    volt_storm: { dmg: 65, stun: 0.15, slow: 0.5, chain: 4 },
    colossus: { dmg: 220, stun: 0.2, slow: 0, radius: 260 },
    super: { dmg: 9999, stun: 0.1, slow: 0 }
  };
  ...
  const BY_WORLD = {
    neon: [
      E('dron_vigia', 'Dron Vigía', 1, true, 400, 'sine', '#22e6ff', 40, 32),
      E('bloque_centinela', 'Bloque Centinela', 2, true, 450, 'charge', '#a855f7', 48, 40)
    ],
    golden: [
      E('guardian_arena', 'Guardián de Arena', 2, true, 500, 'burrow', '#fbbf24', 46, 38),
      E('escarabajo_solar', 'Escarabajo Solar', 1, true, 420, 'hop', '#fb923c', 40, 28)
    ],
    ice: [
      E('golem_escarcha', 'Golem de Escarcha', 3, true, 500, 'ground', '#7dd3fc', 52, 48),
      E('cristal_errante', 'Cristal Errante', 1, true, 400, 'sine', '#e0f2fe', 34, 34)
    ],
    coliseum: [
      E('gladiador_fantasma', 'Gladiador Fantasma', 3, true, 480, 'charge', '#fdba74', 46, 50),
      E('lanza_espectral', 'Lanza Espectral', 1, true, 500, 'homing', '#f97316', 28, 28)
    ],
    abyssal: [
      E('medusa_abisal', 'Medusa Abisal', 2, false, 450, 'sine', '#2ee8c0', 44, 44),
      E('anguila_presion', 'Anguila de Presión', 1, true, 400, 'zigzag', '#67e8f9', 50, 22)
    ],
    celestial: [
      E('serafin_mecanico', 'Serafín Mecánico', 2, true, 420, 'figure8', '#a8c8ff', 42, 36),
      E('nube_estatica', 'Nube Estática', 99, false, 600, 'static', '#e2e8f0', 56, 32)
    ],
    quantum: [
      E('esporo_fractal', 'Esporo Fractal', 1, true, 400, 'sine', '#4ade80', 36, 36),
      E('raiz_cuantica', 'Raíz Cuántica', 2, true, 400, 'blink', '#86efac', 40, 40)
    ],
    igneous: [
      E('nucleo_fundido', 'Núcleo Fundido', 2, true, 450, 'hop', '#fb7185', 40, 40),
      E('lanzallamas_tect', 'Lanzallamas Tectónico', 4, false, 600, 'ground', '#f97316', 54, 46)
    ],
    fractal: [
    ...
    final: [
      E('vigia_elite', 'Vigía Élite', 2, true, 320, 'sine', '#ffd24a', 42, 34),
